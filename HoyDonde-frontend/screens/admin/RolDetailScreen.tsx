  ...
  return (
    <View style={styles.container}>
      ...
      <ConfirmDialog
        ...
        message={`Los usuarios con "${rol.nombre}" perderán las acciones que solo obtienen por este rol. Si esta operación dejaría el sistema sin ningún Administrador efectivo, la API la va a rechazar.`}
